...
public class YumSubmission {
	...
	public YumSubmission () {
		setDefaults();
	}
	
	public YumSubmission (ParseObject po) {
	...
	public YumSubmission (int rating, long waittime, String comment, String restuarantId) {
		setDefaults();
		setRating(rating);
